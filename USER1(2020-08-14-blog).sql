...
/*
SQL Developer와 기타 다른 프로그래밍 프로젝트와 연동을 할때
SQL Developer에서 insert,update,delete 를 수행했음에도 불구하고
...
VALUES(SEQ_BLOG.NEXTVAL, '홍길동','2020-08-14','09:47:00','나의블로그','블로그를 만들자');

INSERT INTO tbl_blogs(bl_seq, bl_user, bl_date, bl_time, bl_title, bl_contents)
VALUES(SEQ_BLOG.NEXTVAL, '이몽룡','2020-08-14','09:47:01','블로그추카','블로그개설을 축하합니다!');

INSERT INTO tbl_blogs(bl_seq, bl_user, bl_date, bl_time, bl_title, bl_contents)
VALUES(SEQ_BLOG.NEXTVAL, '성춘향','2020-08-14','09:47:02','블로그추카','블로그개설을 축하합니다:)');
COMMIT;
